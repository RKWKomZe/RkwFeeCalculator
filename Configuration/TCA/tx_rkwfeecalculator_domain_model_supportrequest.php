...
return [
    ...
    'types' => [
        '1' => [
            ...
            premature_start, file, send_documents, bafa_support, de_minimis 
            '
        ],
    ],
    'columns' => [
