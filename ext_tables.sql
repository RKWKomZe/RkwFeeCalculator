...
CREATE TABLE tx_rkwfeecalculator_domain_model_program (
	...
	consultant_fee_per_day_limit double(14,10) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_rkwfeecalculator_domain_model_institution'
#
CREATE TABLE tx_rkwfeecalculator_domain_model_institution (
